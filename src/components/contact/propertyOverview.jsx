...
import location from "../../assets/Icons/Vector (7).png"
import house from "../../assets/Icons/Vector (8).png"
import angle from "../../assets/Icons/Vector (9).png"
import vec from "../../assets/Icons/Vector (10).png"
import sam from "../../assets/Image/Ellipse 1.png"
    ...
    <Wrapper>
        <div className='py-4 w-full flex flex-col lg:flex-row gap-16'>
           ...
           <div className='py-5 w-full text-center lg:text-start'>
            ...
            <div className='py-12 lg:w-[454px] w-full'>
            <div className='rounded-3xl bg-[#CCCCCC80] h-[634px]'>
                <div className='text-center py-10'>
                    ...
                    <p className='lg:w-[452px] lg:h-[76px] w-full  text-xl md:p-4 text-center'>Don’t miss the opportunity to make this stunning mansion your new home. Contact us today for more information or to schedule a private viewing.</p>
                </div>
